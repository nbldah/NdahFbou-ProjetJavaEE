<%@ page import="projetjavaee.DemandeVisiteMusee" %>
...
<div class="fieldcontain ${hasErrors(bean: demandeVisiteMuseeInstance, field: 'demandeVisite', 'error')} required">
	...
	<g:select id="demandeVisite" name="demandeVisite.id" from="${projetjavaee.DemandeVisite.list()}" optionKey="id" required="" value="${demandeVisiteMuseeInstance?.demandeVisite?.id}" class="many-to-one"/>
...
<div class="fieldcontain ${hasErrors(bean: demandeVisiteMuseeInstance, field: 'musee', 'error')} required">
	...
	<g:select id="musee" name="musee.id" from="${projetjavaee.Musee.list()}" optionKey="id" required="" value="${demandeVisiteMuseeInstance?.musee?.id}" class="many-to-one"/>
