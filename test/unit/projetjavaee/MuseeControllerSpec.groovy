...
class MuseeControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        ...
        Adresse adresse = new Adresse(numero: "2", rue: "RUE DES ARCHIVES", codePostal: "31500", ville: "Toulouse").save()
        ...
        params["horairesOuverture"] = '"Ouvert du lundi au vendredi de 9h à 17h. Fermeture de 12h à 13h30 pendant toutes les vacances scolaires. Fermeture annuelle la dernière quinzaine de juillet."'
        params["telephone"] = "05 61 61 63 33"
        params["accesBus"] = "34"
        params["accesMetro"] =  "Roseraie (A)"
        params["adresse"] = adresse
        params["gestionnaire"] = gestionnaire    }


    void "test the search of a museum"()
    {

        when:"The doSearchMusee action is executed"
        controller.doSearchMusee()

        then: "A redirect is issued to the index with no error"
